...
out_path_loss = "out/finetune_loss_transfer_v2.pt" # loss per batch
    ...
    with open(os.path.join(root_dir, 'photos.json'), 'r') as file:
        ...
        for line in file:
            ...
            try:
                ...
                has_captions = len(caption) > 0 or no_captions 
                if (photo_record['label'] == label and has_captions and 
                    photo_path not in test_set and photo_id != "LXT4hCf1lRyUeM4HDBaSvg"):
